import { RegisterFormValues } from '../../components/Form/RegisterForm/RegisterFormCard';
import { GetCookieValue } from '../Cookie/GetCookieValues';

export const RegValidationHandler = (values: RegisterFormValues): RegisterFormValues => {
	...
	return errors as RegisterFormValues;
};
