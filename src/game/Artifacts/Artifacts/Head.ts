...
const DragonToothCrown = new Artifact(
...
const CrownSupremeMagi = new Artifact(
...
const HellstormHelmet = new Artifact(
...
const ChaosHelmet = new Artifact(
	'Шлем Хаоса',
...
const HeavenlyEnlightenmentHelmet = new Artifact(
...
const AlabasterUnicorcHelm = new Artifact(
...
const SeaCaptainshat = new Artifact(
...
const SkullHelmet = new Artifact(
	'Шлем-череп',
...
const SpellbindersHat = new Artifact(
	'Шляпа волшебника',
...
const ThunderHelmet = new Artifact(
...
export const HeadArtifacts = [
	DragonToothCrown,
	CrownSupremeMagi,
	HellstormHelmet,
	ChaosHelmet,
	HeavenlyEnlightenmentHelmet,
	AlabasterUnicorcHelm,
	SeaCaptainshat,
	SkullHelmet,
	SpellbindersHat,
	ThunderHelmet,
