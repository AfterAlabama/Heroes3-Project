...
export const Blackshard = new Artifact(
...
export const CentaurAxe = new Artifact(
  'Секира кентавра',
...
export const GnollsFlail = new Artifact(
...
export const OgresClub = new Artifact(
...
export const RedDragon = new Artifact(
...
export const SwordHellfire = new Artifact(
  'Меч адского пламени',
...
export const SowrdJudgement = new Artifact(
  'Меч правосудия',
...
export const TitanGladius = new Artifact(
  'Гладиус титана',
