...
export const DiplomatsRing = new Artifact(
  'Кольцо дипломата',
...
export const EquastrianGloves = new Artifact(
  'Перчатки всадника',
...
export const EverslokingSulfurRing = new Artifact(
  'Вечное кольцо серы',
...
export const quietDragonEye = new Artifact(
...
export const ConjuringRing = new Artifact(
  'Магическое кольцо',
...
export const InfiniteGemsRing = new Artifact(
...
export const LifeRing = new Artifact(
  'Кольцо жизни',
...
export const WayfarerRing = new Artifact(
  'Кольцо странника',
...
export const VitalityRing = new Artifact(
...
export const StillDragonEye = new Artifact(
