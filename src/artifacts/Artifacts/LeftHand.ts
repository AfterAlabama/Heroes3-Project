...
export const BucklerGnollKing = new Artifact(
  'Щит короля гноллов',
...
export const DragonScaleShield = new Artifact(
...
export const LionCourageShield = new Artifact(
...
export const SentinelShield = new Artifact(
  'Щит часового',
...
export const DamnedShield = new Artifact(
  'Щит проклятых',
...
export const DwarvenLordsShield = new Artifact(
  'Щит короля гномов',
...
export const YawningDeadShield = new Artifact(
...
export const TargRampagingOgre = new Artifact(
  'Щит яростного огра',
