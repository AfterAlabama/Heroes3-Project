...
export const LevitationBoots = new Artifact(
  'Сапоги левитации',
...
export const PolarityBoots = new Artifact(
  'Башмаки полярности',
...
export const SpeedBoots = new Artifact(
  'Сапоги-скороходы',
...
export const DeadmansBoots = new Artifact(
  'Башмаки мертвеца',
...
export const DragonBoneGreaves = new Artifact(
...
export const SaintSndals = new Artifact(
  'Сандалии святого',
