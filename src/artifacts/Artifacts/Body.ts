...
export const WonderArmor = new Artifact(
  'Магические доспехи',
...
export const BrimstoneBreastplate = new Artifact(
...
export const PetrifiedWoodBreastplate = new Artifact(
...
export const DragonScaleArmor = new Artifact(
...
export const RibCage = new Artifact(
  'Рёбра',
...
export const GreatBasilistScales = new Artifact(
...
export const TitansCuirass = new Artifact(
  'Кираса титана',
...
export const CyclopsKingTunic = new Artifact(
