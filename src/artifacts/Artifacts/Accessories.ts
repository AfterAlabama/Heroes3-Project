...
export const AngelFeatherArrows = new Artifact(
...
export const LegionArms = new Artifact(
  'Руки Легионера',
...
export const CourageBadge = new Artifact(
  'Медаль мужества',
...
export const PerceptionBird = new Artifact(
...
export const ElvenCherryWoodBow = new Artifact(
...
export const UnicornsManeBowString = new Artifact(
...
export const ProphecyCards = new Artifact(
  'Карты пророчества',
...
export const ManaCharm = new Artifact(
  'Амулет маны',
...
export const FortuneClover = new Artifact(
  'Клевер удачи',
...
export const ValorCrest = new Artifact(
  'Знак отваги',
...
export const CognizanceEmblem = new Artifact(
  'Символ знания',
...
export const EndlessGoldBag = new Artifact(
...
export const EndlessGoldPurse = new Artifact(
...
export const EndlessGoldsack = new Artifact(
...
export const EverpouringMercuryVial = new Artifact(
...
export const GallantryGlyph = new Artifact(
  'Глиф доблести',
...
export const GoldenBow = new Artifact(
  'Золотой лук',
...
export const LegionHead = new Artifact(
  'Голова Легионера',
...
export const EvilHourHourglass = new Artifact(
...
export const InexhaustibleLumberCart = new Artifact(
...
export const InexhaustibleOreCart = new Artifact(
...
export const LuckLadybird = new Artifact(
  'Голубка удачи',
...
export const LegionLegs = new Artifact(
  'Ноги Легионера',
...
export const LegionLoins = new Artifact(
  'Поясница Легионера',
...
export const MysticManaOrb = new Artifact(
...
export const DrivingRainOrb = new Artifact(
...
export const InhibitionOrb = new Artifact(
  'Сфера запрещения',
...
export const SiltOrb = new Artifact(
...
export const TempestuousFireOrb = new Artifact(
...
export const FirmamentOrb = new Artifact(
...
export const VulnerabilityOrb = new Artifact(
  'Сфера уязвимости',
...
export const WarShackles = new Artifact(
  'Оковы войны',
...
export const Speculum = new Artifact(
  'Телескоп',
...
export const PermanenceSphere = new Artifact(
  'Сфера постоянства',
...
export const OppressionSpirit = new Artifact(
  'Дух уныния',
...
export const Spyglass = new Artifact(
  'Подзорная труба',
...
export const StoicWatchman = new Artifact(
  'Стойкий часовой',
...
export const ManaTalisman = new Artifact(
  'Талисман маны',
...
export const AirMagicTome = new Artifact(
  'Книга магии Воздуха',
...
export const EarthMagicTome = new Artifact(
  'Книга магии Земли',
...
export const FireMagicTome = new Artifact(
  'Книга магии Огня',
...
export const WaterMagicTome = new Artifact(
  'Книга магии Воды',
...
export const LegionTorso = new Artifact(
  'Торс Легионера',
...
export const LifeBloodVial = new Artifact(
