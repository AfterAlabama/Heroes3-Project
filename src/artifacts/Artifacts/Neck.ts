...
const UndertakerAmulet = new Artifact(
	'Амулет гробовщика',
...
const CelestialNecklaceOfBliss = new Artifact(
...
const CollarOfConjuring = new Artifact(
	'Магический ошейник',
...
const InterferenceGarniture = new Artifact(
...
const DragonTeethNecklace = new Artifact(
...
const OceanGuidanceNecklace = new Artifact(
...
const SwiftnessNecklace = new Artifact(
...
const CouragePendant = new Artifact(
	'Брелок смелости',
...
const DeathPendant = new Artifact(
	'Кулон смерти',
...
const DispassionPendant = new Artifact(
	'Амулет бесстрастия',
...
const FreeWillPendant = new Artifact(
...
const HolinessPendant = new Artifact(
	'Священный брелок',
...
const LifePendant = new Artifact(
	'Брелок жизни',
...
const NegativityPendant = new Artifact(
...
const TotalRecallPendant = new Artifact(
...
const SecondSightPendant = new Artifact(
	'Брелок ясновидения',
...
const StatesmanMedal = new Artifact(
	'Медаль чиновника',
...
export const NeckArtifacts = [
	UndertakerAmulet,
	CelestialNecklaceOfBliss,
	CollarOfConjuring,
	InterferenceGarniture,
	DragonTeethNecklace,
	OceanGuidanceNecklace,
	SwiftnessNecklace,
	CouragePendant,
	DeathPendant,
	DispassionPendant,
