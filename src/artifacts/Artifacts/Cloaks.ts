...
export const AmbassadorSash = new Artifact(
  'Лента посла',
...
export const AngelWings = new Artifact(
  'Крылья ангела',
...
export const ConjuringCape = new Artifact(
  'Магическая накидка',
...
export const VelocityCape = new Artifact(
  'Накидка скорости',
...
export const DragonWingTabard = new Artifact(
...
export const EverflowingCrystallCloak = new Artifact(
...
export const RecantersCloak = new Artifact(
  'Плащ отречения',
...
export const CounterpoiseSurcoat = new Artifact(
  'Туника равновесия',
...
export const VampiresCowl = new Artifact(
  'Мантия вампира',
